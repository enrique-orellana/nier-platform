...
This project is indexed by GitNexus as **nier-platform** (7257 symbols, 17494 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
