...
This project is indexed by GitNexus as **openshorts** (5751 symbols, 20174 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
