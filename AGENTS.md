...
This project is indexed by GitNexus as **nier-platform** (7560 symbols, 18137 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
