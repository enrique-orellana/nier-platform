...
This project is indexed by GitNexus as **nier-platform** (6958 symbols, 16857 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
