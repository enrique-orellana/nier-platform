...
describe('SubtitleDetailsModal', () => {
    it('shows saved cue text, relative/master timestamps, and a rendered preview', () => {
        ...
        expect(screen.getByRole('heading', { name: /subtitle details/i })).toBeInTheDocument();
        ...
        expect(screen.getByTestId('subtitle-details-preview')).toHaveTextContent('Hello there');
    });
});
