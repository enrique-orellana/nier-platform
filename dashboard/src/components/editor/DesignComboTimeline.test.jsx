...
const state = {
    ...
    fps: 30,
    tracks: [
        { id: 'video-1', name: 'V1', type: 'video', muted: false, locked: false, visible: true, items: [{ id: 'source', type: 'video', label: 'Source', start: 0, end: 10 }] },
        { id: 'hook', name: 'Hook', type: 'hook', muted: false, locked: false, visible: true, items: [{ id: 'hook-1', type: 'hook', label: 'Hook', start: 1, end: 3 }] },
    ],
};
