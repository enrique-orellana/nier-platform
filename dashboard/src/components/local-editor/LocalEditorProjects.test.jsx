...
const projects = [
    { id: 'one', name: 'One', videoName: 'one.mp4', durationMs: 65000, updatedAt: Date.now() },
    { id: 'two', name: 'Two', videoName: 'two.mp4', durationMs: 12000, updatedAt: Date.now() - 1000 },
];
...
describe('LocalEditorProjects', () => {
    ...
    it('renders nothing while closed', () => {
        const { container } = render(<LocalEditorProjects open={false} projects={[]} />);
