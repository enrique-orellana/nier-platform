...
export const SOCIAL_OUTPUT_DIMENSIONS = Object.freeze({
  width: 1080,
  height: 1920,
});
...
export const getFilledFrameDimensions = (
  width,
  height,
  targetAspect = 9 / 16,
) => {
  ...
  if (sourceAspect > targetAspect) {
    return {
      width: evenDimension(sourceHeight * targetAspect),
      height: evenDimension(sourceHeight),
    };
  }
  return {
    width: evenDimension(sourceWidth),
    height: evenDimension(sourceWidth / targetAspect),
  };
};
