...
import { getSubtitleFrameRange, getSubtitleTimeMs, normalizeSubtitleConfig } from './Subtitles';
...
describe('subtitle rendering defaults', () => {
    ...
    it('uses one consistent absolute frame range for subtitle sequences', () => {
        expect(getSubtitleFrameRange({ startMs: 340, endMs: 720 }, 30)).toEqual({ startFrame: 10, endFrame: 22, durationFrames: 12 });
