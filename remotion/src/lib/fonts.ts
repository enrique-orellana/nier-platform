...
/**
 * Keep emoji fallback explicit because the renderer container does not use
 * the host operating system's font set.
 */
...
@font-face {
  ...
  src: url('${staticFile("fonts/OpenShortsSans.ttf")}') format('truetype');
  font-weight: 400;
  font-style: normal;
}
@font-face {
  font-family: 'OpenShortsSans';
  src: url('${staticFile("fonts/OpenShortsSans-Bold.ttf")}') format('truetype');
  font-weight: 700;
  font-style: normal;
}
@font-face {
  font-family: 'OpenShortsImpact';
  src: url('${staticFile("fonts/OpenShortsImpact.ttf")}') format('truetype');
  font-weight: 700;
  font-style: normal;
}
@font-face {
  font-family: 'OpenShortsSerif';
  src: url('${staticFile("fonts/OpenShortsSerif.ttf")}') format('truetype');
  font-weight: 400;
  font-style: normal;
}
@font-face {
  font-family: 'OpenShortsSerif';
  src: url('${staticFile("fonts/OpenShortsSerif-Bold.ttf")}') format('truetype');
  font-weight: 700;
  font-style: normal;
}
@font-face {
  font-family: 'OpenShortsMono';
  src: url('${staticFile("fonts/OpenShortsMono.ttf")}') format('truetype');
  font-weight: 400;
  font-style: normal;
}
@font-face {
  font-family: 'OpenShortsMono';
  src: url('${staticFile("fonts/OpenShortsMono-Bold.ttf")}') format('truetype');
  font-weight: 700;
  font-style: normal;
}
`;
...
export function getFontStack(fontFamily: string): string {
  ...
  return stack.replace(/,\s*(sans-serif|serif)\s*$/, `, ${COLOR_EMOJI_FONT_STACK}, $1`);
}
